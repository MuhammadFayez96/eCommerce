                    ...
                    <div class="mainBought">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                <label for="role" class="col-2 col-form-label">User`s Role</label>
                                <div class="col-10">
                        ...
                        <div class="bought col-sm-12 row" style="margin-bottom: 35px;">
                            ...
                            <div class="row col-sm-12">
                                ...
                                <div class="form-group col-sm-2" style="margin-top: 45px;">
                                    <div class="col-10">
                                        <button type="button" name="add_product_section"
                                                data-url = "{{route('admin.boughts.getBoughtSectionView')}}"
                                                class="btn btn-primary btn-md add_product_section">+
                                        </button>
                                    </div>
                                </div>
                                <!-- end div plus button  -->
